        ...
        <div class="container">
            <div class="row align-content-center">
                <div class="col-lg-6 col-md-6 mb-4">
                     <img class="img-fluid" src="/assets/images/accounting-and-bookkeeping-1.png" />
                </div>
        ...
        <div class="container">
            <div class="row align-items-center mb-5">
                <div class="col-lg-5 col-md-5">
                    <img class="img-fluid mb-4" src="/assets/images/accounting-and-bookkeeping-2.png" />
                </div>
     ...
     <section class="space-p-tb"> 
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-5">
                    <img class="img-fluid" src="/assets/images/accounting-and-bookkeeping-3.png" />
                </div>
            </div>
        </div>
    </section>
